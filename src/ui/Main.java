...
public class Main {
	...
	public int menu() {
		...
		System.out.println("* (2) Mostrar el n�mero de personas que han intentado entrar*");
		...
		do {
			...
			try {
				...
				System.out.println("El valor digitado no es num�rico, por favor corregirlo");
			}
	...
	public void registerPerson() {
		...
		System.out.println("* (2) C�dula de Ciudadan�a     *");
		System.out.println("* (3) Pasaporte                *");
		System.out.println("* (4) C�dula de Extranjer�a    *");
		System.out.println("********************************");
			...
			do {
				try {
					...
					if(optionToDocument != 1 && optionToDocument != 2 && optionToDocument != 3 && optionToDocument != 4) {
						System.out.println("Opci�n no valida, digitelo nuevamente");
					}
					else {
					...
					System.out.println("El valor digitado no tiene el pen�ltimo valor num�rico, por favor corregirlo");
				}catch(MinorException mE) {
					
					System.out.println("***********************************************************************************");
					System.out.println("*  La persona que est� intentando ingresar NO puede entrar por ser menor de edad  *");
					System.out.println("***********************************************************************************");
				}catch(PickAndCedulaException pcE) {
					System.out.println("**********************************************************************************************");
					System.out.println("*  La persona que est� intentando ingresar NO puede entrar porque no le corresponde el d�a   *");
					System.out.println("**********************************************************************************************");
				}
	...
	public void consultPerson() {
		...
		System.out.println("N�mero de personas: "+market.getContPoeple());
	}
}